...
/**
 * Dada una secuencia de caracteres introducida por teclado, visualizar las 
 * palabras con un número par de caracteres al revés y las palabras con un
 * número impar de caracteres de forma normal.
 * @author joanpont
 */
...
public class Ejercicio8 {
    public static void main(String[] args){
        ...
        while(temp<caracteres.length){
            ...
            // Imprimimos las palabras con un número par de caraceres al revés
            // y las que tienen un número impar de caracteres las imprimimos normal
